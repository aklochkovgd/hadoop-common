...
public class TestYarnCLI {
  ...
  private String createApplicationCLIHelpMessage() throws IOException {
    ...
    pw.println("                             states. The valid application state can be");
    pw.println("                             one of the following:");
    ...
    pw.println("                             on input comma-separated list of application");
    pw.println("                             types.");
    pw.println(" -failAttempt <App/Att ID>   Fails application attempt. If application ID");
    pw.println("                             is provided, the current attempt will be");
    pw.println("                             failed. Otherwise specified attempt ID will");
    pw.println("                             be failed.");
